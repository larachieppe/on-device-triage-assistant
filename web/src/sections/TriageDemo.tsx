...
// One real example per category, phrased like the hard eval set (casual,
// not templated) — lets a visitor see all four outcomes without having to
// think of their own symptom description first.
const EXAMPLES: { label: string; text: string }[] = [
  { label: "Self care", text: "I have a mild headache and a runny nose" },
  { label: "Routine care", text: "I've had this same mild headache pattern every few days for the past month" },
  { label: "Urgent care", text: "Sudden severe ear pain that started a few hours ago and it's getting worse" },
  { label: "Emergency", text: "Chest feels really tight and I'm having trouble breathing" },
];
...
export default function TriageDemo() {
  ...
  const runCheck = async (inputText: string) => {
  ...
  return (
    <section id="try" className="demo-section">
      <div className="section-head">
        <span className="eyebrow eyebrow--muted">Try it</span>
        <h2>Describe what you're experiencing</h2>
        <p className="section-sub">
          Or try one of these — each one lands on a different category.
        </p>
      </div>
